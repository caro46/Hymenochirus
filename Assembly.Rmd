...
```
For the male genome we obtain less "big" scaffolds (63mers: 3 scaffolds>100K, default: 5 scaffolds>100K, also smaller median size). For both genomes N50 and longest sequence size are a little better (still less convincing than abyss individual genomes).
