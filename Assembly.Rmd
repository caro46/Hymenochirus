...
We also identified scaffolds of female when we have a mean of scaffold coverage for male: `round(DFA_order_m$malecoverage)<=0` & `round(DFA_order_m$malecoverage)<=1`.

Results of blast when blasting specific female scaffolds identified by the coverage
```
