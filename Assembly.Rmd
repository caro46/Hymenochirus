...
Try to improve - multi kmers approach
/home/evanslab/tetra_project/Assembly/SOAP/SOAPdenovo2-src-r240/SOAPdenovo-63mer all -s /home/evanslab/Hymeno_fastqc/assembly_SOAP_info_chimerical/hymeno.config -K 43 -m 63 -R -V -p 10 -o /net/infofile4-inside/volume1/scratch/evanslab/Hymenochirus_2016/Assembly/SOAP_Hymeno_genome_chimerical_43_63mers 
killed

/home/evanslab/tetra_project/Assembly/SOAP/SOAPdenovo2-src-r240/SOAPdenovo-63mer all -s /home/evanslab/Hymeno_fastqc/assembly_SOAP_info_chimerical/hymeno.config -K 63 -R -V -p 10 -o /net/infofile4-inside/volume1/scratch/evanslab/Hymenochirus_2016/Assembly/SOAP_Hymeno_genome_chimerical_63mers
killed

/home/evanslab/tetra_project/Assembly/SOAP/SOAPdenovo2-src-r240/SOAPdenovo-63mer all -s /home/evanslab/Hymeno_fastqc/assembly_SOAP_info_chimerical/hymeno.config -K 61 -R -V -p 10 -o /net/infofile4-inside/volume1/scratch/evanslab/Hymenochirus_2016/Assembly/SOAP_Hymeno_genome_chimerical_61mers
killed

/home/evanslab/tetra_project/Assembly/SOAP/SOAPdenovo2-src-r240/SOAPdenovo-127mer all -s /home/evanslab/Hymeno_fastqc/assembly_SOAP_info_chimerical/hymeno.config -K 81 -R -V -p 10 -o /net/infofile4-inside/volume1/scratch/evanslab/Hymenochirus_2016/Assembly/SOAP_Hymeno_genome_chimerical_81mers
Error: aio_return error
Try another time: Killed

/home/evanslab/tetra_project/Assembly/SOAP/SOAPdenovo2-src-r240/SOAPdenovo-127mer all -s /home/evanslab/Hymeno_fastqc/assembly_SOAP_info_chimerical/hymeno.config -K 91 -R -V -p 10 -o /net/infofile4-inside/volume1/scratch/evanslab/Hymenochirus_2016/Assembly/SOAP_Hymeno_genome_chimerical_91mers

Iqaluk
/work/ben/2016_Hymenochirus/SOAPdenovo2-src-r240/SOAPdenovo-127mer all -s /work/cauretc/2016_Hymenochirus/SOAP_chimerical/hymeno.config -K 65 -R -F -V -p 20 -o /work/cauretc/2016_Hymenochirus/SOAP_chimerical/SOAP_Hymeno_genome_chimerical_65mers

/work/ben/2016_Hymenochirus/SOAPdenovo2-src-r240/SOAPdenovo-63mer all -s /work/cauretc/2016_Hymenochirus/SOAP_chimerical/hymeno.config -K 43 -m 63 -R -F -V -p 20 -o /work/cauretc/2016_Hymenochirus/SOAP_chimerical/SOAP_Hymeno_genome_chimerical_43_63mers

```
**Notes 09/08**: Required too much memory to run on info even using `SOAPdenovo-63mer` or bigger kmer (in order to simplify the graph). Need to use sharcnet when clusters will be up and run with at least K = 65 & 67. Multi-kmer approach even if seemed to be very interesting require much more time & memory. Try with `-K 61 -m 71`.

**Notes **: Can't use other k-mer size than the default for SOAPdenovo when trying to build the chimerical genome (K-mer size= 67, 65, 37...). All the time failed because of memory issues. Even then, because changing k-mer size doesn't change drastically the results obtained for male and female genomes, we can still use the chimerical one.
...
Try to improve:
```
/home/evanslab/tetra_project/Assembly/SOAP/SOAPdenovo2-src-r240/SOAPdenovo-63mer all -s /home/evanslab/Hymeno_fastqc/assembly_SOAP_info_chimerical/hymeno_male_info.config -K 63 -R -V -F -p 10 -o /net/infofile4-inside/volume1/scratch/evanslab/Hymenochirus_2016/Assembly/SOAP_Hymeno_MALE_genome_info_63mers

/work/ben/2016_Hymenochirus/SOAPdenovo2-src-r240/SOAPdenovo-63mer all -s /work/cauretc/2016_Hymenochirus/SOAP_chimerical/hymenoFEMALE.config -K 63 -R -F -V -p 20 -o /work/cauretc/2016_Hymenochirus/SOAP_chimerical/SOAP_Hymeno_genome_Female_63mers
```
For the male genome we obtain less "big" scaffolds (63mers: 3 scaffolds>100K, default: 5 scaffolds>100K, also smaller median size). For both genomes N50 and longest sequence size are a little better (still less convincing than abyss individual genomes). Need also to run without the `-F` that was used to improve the n50 by resolving `N` in the middle of scaffolds because use too much memory and can't finish without crashing.
```
/work/ben/2016_Hymenochirus/SOAPdenovo2-src-r240/SOAPdenovo-63mer all -s /work/cauretc/2016_Hymenochirus/SOAP_chimerical/hymenoFEMALE.config -K 43 -R -V -p 20 -o /work/cauretc/2016_Hymenochirus/SOAP_chimerical/SOAP_Hymeno_genome_Female_43mers
```
N50 is better, the mean size too but the longest sequence is smaller and this time we have only 1 scaffold with a size > 100K and 26648 scaffolds >10K.
...
## NOTES:
- xenTrop9 `Xtropicalis_v9_repeatMasked.fa` of Xenbase: soft masked. To make manually hard masked:
```
tr '[:lower:]' 'N' Xtropicalis_v9_repeatMasked.fa > Xtropicalis_v9_repeatMasked_HARD_MASK.fa
sed 's/>CNN/>Chr/' Xtropicalis_v9_repeatMasked_HARD_MASK.fa >Xtropicalis_v9_repeatMasked_HARD_MASK1.fa
sed 's/>NNNNNNNN_/>scaffold_/' Xtropicalis_v9_repeatMasked_HARD_MASK1.fa >Xtropicalis_v9_repeatMasked_HARD_MASK2.fa
```
Then run blast and BWA again (to see if not considering repeat elements help to align *X. tropicalis* and *Hymenochirus*)
```
makeblastdb -in /work/ben/2016_Hymenochirus/xenTro9/Xtropicalis_v9_repeatMasked_HARD_MASK.fa -dbtype nucl -title xenBase_xenTro9_HARD -out /work/ben/2016_Hymenochirus/xenTro9/xenTro9_genome_HARDmasked_blastable
blastn -evalue 1e-20 -query /work/ben/2016_Hymenochirus/BJE3814/blast/scaffolds_sup_fem_caract_depth_round1.fa -db /work/ben/2016_Hymenochirus/xenTro9/xenTro9_genome_HARDmasked_blastable -out /work/ben/2016_Hymenochirus/BJE3814/blast/BJE3814_scaffolds_sup_caract_fem_depth_round1_results_xenTro9_hard_mask_e20 -outfmt 6 -max_target_seqs 1
blastn -evalue 1e-5 -query /work/ben/2016_Hymenochirus/BJE3814/blast/scaffolds_sup_fem_caract_depth_round1.fa -db /work/ben/2016_Hymenochirus/xenTro9/xenTro9_genome_HARDmasked_blastable -out /work/ben/2016_Hymenochirus/BJE3814/blast/BJE3814_scaffolds_sup_caract_fem_depth_round1_results_xenTro9_hard_mask_e5 -outfmt 6 -max_target_seqs 1
```
```
bwa index /net/infofile2/2/scratch/evanslab_backups/Hymenochirus_2016/abyss/Xtrop/Xtropicalis_v9_repeatMasked_HARD_MASK.fa
bwa mem /net/infofile2/2/scratch/evanslab_backups/Hymenochirus_2016/abyss/Xtrop/Xtropicalis_v9_repeatMasked_HARD_MASK.fa /net/infofile2/2/scratch/evanslab_backups/Hymenochirus_2016/TCAG_20160129/160106_E00389_0017_AHK3LJCCXX/BJE3814_S3_L003_R1_001_trim_paired.cor.fastq.gz /net/infofile2/2/scratch/evanslab_backups/Hymenochirus_2016/TCAG_20160129/160106_E00389_0017_AHK3LJCCXX/BJE3814_S3_L003_R2_001_trim_paired.cor.fastq.gz >/net/infofile2/2/scratch/evanslab_backups/Hymenochirus_2016/abyss/samfiles/aln_bwa_mem_Xtrop9_HARD_BJE3814_reads.sam
samtools view -bt /net/infofile2/2/scratch/evanslab_backups/Hymenochirus_2016/abyss/Xtrop/Xtropicalis_v9_repeatMasked_HARD_MASK.fa -o /home/evanslab/Hymeno_fastqc/map_reads_to_abyss_genomes/tropicalis/aln_bwa_mem_Xtrop9_HARD_BJE3814_reads.bam /net/infofile2/2/scratch/evanslab_backups/Hymenochirus_2016/abyss/samfiles/aln_bwa_mem_Xtrop9_HARD_BJE3814_reads.sam
samtools sort /home/evanslab/Hymeno_fastqc/map_reads_to_abyss_genomes/tropicalis/aln_bwa_mem_Xtrop9_HARD_BJE3814_reads.bam /home/evanslab/Hymeno_fastqc/map_reads_to_abyss_genomes/tropicalis/aln_bwa_mem_Xtrop9_HARD_BJE3814_reads_sorted
samtools index /home/evanslab/Hymeno_fastqc/map_reads_to_abyss_genomes/tropicalis/aln_bwa_mem_Xtrop9_HARD_BJE3814_reads_sorted.bam
samtools flagstat /home/evanslab/Hymeno_fastqc/map_reads_to_abyss_genomes/tropicalis/aln_bwa_mem_Xtrop9_HARD_BJE3814_reads_sorted.bam > /home/evanslab/Hymeno_fastqc/map_reads_to_abyss_genomes/trpicalis/aln_bwa_mem_Xtrop9_HARD_BJE3814_reads_sorted.txt

bwa mem /net/infofile2/2/scratch/evanslab_backups/Hymenochirus_2016/abyss/Xtrop/Xtropicalis_v9_repeatMasked_HARD_MASK.fa /net/infofile2/2/scratch/evanslab_backups/Hymenochirus_2016/TCAG_20160129/160106_E00389_0017_AHK3LJCCXX/BJE3815_S4_L004_R1_001_trim_paired.cor.fastq.gz /net/infofile2/2/scratch/evanslab_backups/Hymenochirus_2016/TCAG_20160129/160106_E00389_0017_AHK3LJCCXX/BJE3815_S4_L004_R2_001_trim_paired.cor.fastq.gz >/net/infofile2/2/scratch/evanslab_backups/Hymenochirus_2016/abyss/samfiles/aln_bwa_mem_Xtrop9_HARD_BJE3815_reads.sam
samtools view -bt /net/infofile2/2/scratch/evanslab_backups/Hymenochirus_2016/abyss/Xtrop/Xtropicalis_v9_repeatMasked_HARD_MASK.fa -o /home/evanslab/Hymeno_fastqc/map_reads_to_abyss_genomes/tropicalis/aln_bwa_mem_Xtrop9_HARD_BJE3815_reads.bam /net/infofile2/2/scratch/evanslab_backups/Hymenochirus_2016/abyss/samfiles/aln_bwa_mem_Xtrop9_HARD_BJE3815_reads.sam
samtools sort /home/evanslab/Hymeno_fastqc/map_reads_to_abyss_genomes/tropicalis/aln_bwa_mem_Xtrop9_HARD_BJE3815_reads.bam /home/evanslab/Hymeno_fastqc/map_reads_to_abyss_genomes/tropicalis/aln_bwa_mem_Xtrop9_HARD_BJE3815_reads_sorted
samtools index /home/evanslab/Hymeno_fastqc/map_reads_to_abyss_genomes/tropicalis/aln_bwa_mem_Xtrop9_HARD_BJE3815_reads_sorted.bam
samtools flagstat /home/evanslab/Hymeno_fastqc/map_reads_to_abyss_genomes/tropicalis/aln_bwa_mem_Xtrop9_HARD_BJE3815_reads_sorted.bam > /home/evanslab/Hymeno_fastqc/map_reads_to_abyss_genomes/trpicalis/aln_bwa_mem_Xtrop9_HARD_BJE3815_reads_sorted.txt
```
> Still ~15% reads map

To do:
```
blastn -evalue 1e-20 -query /work/ben/2016_Hymenochirus/BJE3814/BJE3814-8.fa -db /work/ben/2016_Hymenochirus/xenTro9/xenTro9_genome_HARDmasked_blastable -out /work/ben/2016_Hymenochirus/BJE3814/blast/BJE3814-8_xenTro9_hard_mask_e20 -outfmt 6 -max_target_seqs 1

blastn -evalue 1e-20 -query /work/ben/2016_Hymenochirus/BJE3814/BJE3815-8.fa -db /work/ben/2016_Hymenochirus/xenTro9/xenTro9_genome_HARDmasked_blastable -out /work/ben/2016_Hymenochirus/BJE3814/blast/BJE3815-8_xenTro9_hard_mask_e20 -outfmt 6 -max_target_seqs 1
```

##To sum up: comparing assembly quality

2 softwares were used: Abyss & SOAP de novo. Only SOAP was able to produce a chimerical assembly. Different k-mer size was used with SOAP de novo when dealing with a scpecific assembly for each sex. With abyss we only used the recommended default size. 

To choose k-mer size:

***- Odd numbers range from 3 to 127 (for SOAP de novo)*** (If you accidentally use an even number: SOAP uses the default value 23mers)

***- Smaller k-mer for heterozygous genome***

***- Larger k-mer for genomes with high proportion of repeats***

In the table the ***values*** will represent the best values obtaines between the different assembly attempted (between abyss and SOAP de novo we only compare n50). Between the different SOAP de novo attempted we can notice that depending on the criteria the "best" assembly is not the same.
For the female BJE3814:
- if `n50` is the criteria: 23mer assembly is the best, 
- considering `scaffolds>100K`: 63mer (& 64) is the best
- `Longest_Seq`: 63mer (& 64) assembly is the best

|Individuals|BJE3814|BJE3815|chimerical|
|------|------|------|------|
|**abyss**||||
|kmer_size|64|64|failed|
|n50|<font color='red'>***6580***</font>|<font color='red'>6536</font>||
|**soapdenovo**||||
|*kmer_size*|64(not odd)|64|64|
|n50|1886|1835|631|
|Mean_Size|396|397|293|
|Median_Size|131|131|130|
|Longest_Seq|<font color='red'>***150321***</font>|132924|116517|
|scaffolds>100K|<font color='red'>***5***</font>|5|3|
|*kmer_size*|23(=default)|23|23|
|n50|**4777**|**4746**||
|Mean_Size|**1347**|296||
|Median_Size|263|187||
|Longest_Seq|102077|86976||
|scaffolds>100K|1|0||
|*kmer_size*|33|33||
|n50|4612|4605||
|Mean_Size|1067|**1067**||
|Median_Size|231|**232**||
|Longest_Seq|105860|101704||
|scaffolds>100K|1|1||
|*kmer_size*|43|43||
|n50|4281|4262||
|Mean_Size|931|931||
|Median_Size|224|224||
|Longest_Seq|128647|104146||
|scaffolds>100K|1|1||
|*kmer_size*|53|53||
|n50|2882|2869||
|Mean_Size|471|469||
|Median_Size|107|107||
|Longest_Seq|104116|109187||
|scaffolds>100K|2|3||
|*kmer_size*|63|63||
|n50|1971|1954||
|Mean_Size|400|398||
|Median_Size|127|127||
|Longest_Seq|145680|**199901**||
|scaffolds>100K|<font color='red'>***5***|3||

We also need to keep in mind smaller k-mers produces more complicated graph (more memory used).

**Note 17/10: lab meeting:** 
Suggestion of Brian, why not using Velvet? (Usually good results).
###GapCloser
```
/work/ben/2016_Hymenochirus/GapCloser_dir/GapCloser –b /work/ben/2016_Hymenochirus/SOAPdenovo2-src-r240/hymenoFEMALE.config –a /work/cauretc/2016_Hymenochirus/SOAP_chimerical/SOAP_Hymeno_genome_Female_23mers.scafSeq -t 4 –o /work/cauretc/2016_Hymenochirus/SOAP_chimerical/GapCloser/SOAP_Hymeno_genome_Female_23mers_GapCloser.scafSeq

/work/ben/2016_Hymenochirus/GapCloser_dir/GapCloser –a /work/ben/2016_Hymenochirus/GapCloser_dir/SOAP_Hymeno_genome_Female_23mers.scafSeq –b /work/ben/2016_Hymenochirus/SOAPdenovo2-src-r240/hymenoFEMALE.config -t 4 –o /work/cauretc/2016_Hymenochirus/SOAP_chimerical/GapCloser/SOAP_Hymeno_genome_Female_23mers_GapCloser.scafSeq
```
Trying with .gz and unziped files (even if we were supposed to use the same files as SOAPdenovo...no previous issue with these files and SOAP...); with all the files in the directory of the program; with the program withing the directory of SOAPdenovo but it is still not working. Everything was run from Ben's account: no problem to open the different files, or to find them. Some people had the some issues with the program with apparently no answer... So let's forget this program and give a shot to GapFiller.

```
./GapFiller --seed1 /work/ben/2016_Hymenochirus/BJE3814/BJE3814_S3_L003_R1_001_trim_paired.cor.fastq.gz --seed2 /work/ben/2016_Hymenochirus/BJE3814/BJE3814_S3_L003_R2_001_trim_paired.cor.fastq.gz --seed-ins 350 --gz --seed-var 50 --query /work/ben/2016_Hymenochirus/GapCloser_dir/SOAP_Hymeno_genome_Female_23mers.scafSeq --output-prefix SOAP_Hymeno_genome_Female_23mers_Gapfiller
```
