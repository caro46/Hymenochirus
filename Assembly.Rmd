...
scaffoldsID_unique <- unique(contigsID)
head(scaffoldsID_unique)
#[1] 13964 13970 17295 18041 20125 28074
number_scaffolds_match_BJE3814_XenTrop9 <- length(contigsID_unique)
number_scaffolds_match_BJE3814_XenTrop9
#[1] 38797
```
In `BJE3814-stats.tab` from Abyss output: total number of scaffolds: 7557165 -> 38797/7557165 = 0.5% (FEMALE). For BJE3815 (MALE): 38928/7481189 = 0.5%
