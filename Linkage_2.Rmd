...
* DONE (onemap)
```
File filtered following the GATK best practices for SNP
```
...
```R
library(onemap)
vcf2raw(input = "example.vcf.gz", output = "Hymenochirus_HardFilteredGATK.raw", cross = "outcross", parent1 = "BJE3814", parent2 = "BJE3814")
```
