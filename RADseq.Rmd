...
## Linkage map
Some limitations with some sofwares about cross types: R/ASMap restricted to backcross, doubled haploid and recombinant inbred.
### Plink 
...
#### Input file
To have the correct input file fomat we can either use `Stacks` or a perl script which converts a vcf file to a joinmap file.
