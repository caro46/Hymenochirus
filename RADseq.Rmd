...
cat /net/infofile4-inside/volume1/scratch/evanslab/Hymenochirus_2016/GBS_data/563_S7_L007_R1_001.fastq | grep "^TCCGGAGCGCTGCAGG" | cut -c 9-16 | sort | uniq -c
 879367 GCTGCAGG
```
Checking using different barcode, we always obtained `GCTGCAGG` which is 1 bp difference from the restriction site in their [paper](http://www.g3journal.org/content/1/3/171.full) `CCTGCAGG`.
