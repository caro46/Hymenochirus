...
#super contig 1 issue
$commandline = "grep \"supercontig_1    \" ".$path_to_tab."SOAP_Chimerical_recalibrated_round1_allsites_Phred20.tab \> ".$path_to_tab."big_scaffolds_separated\/"."SOAP_Chimerical_recalibrated_round1_allsites_Phred20_supercontig_1_temp.tab";
print $commandline;
$status = system($commandline);

my $header="header.text";
$commandline = "cat ".$header." ".$path_to_tab."big_scaffolds_separated\/"."SOAP_Chimerical_recalibrated_round1_allsites_Phred20_supercontig_1_temp.tab \> ".$path_to_tab."big_scaffolds_separated\/"."SOAP_Chimerical_recalibrated_round1_allsites_Phred20_supercontig_1.tab" ;
print $commandline;
$status = system($commandline);
$commandline = "rm -f ".$path_to_tab."big_scaffolds_separated\/"."SOAP_Chimerical_recalibrated_round1_allsites_Phred20_supercontig_1_temp.tab";
print $commandline;
$status = system($commandline);

$commandline = "grep \"^1       \" ".$path_to_inputfile.$inputfile." \> ".$path_to_tab."big_scaffolds_separated\/".$inputfile."_supercontig_1_temp";
print $commandline;
$status = system($commandline);
$commandline = "cat ".$header." ".$path_to_tab."big_scaffolds_separated\/".$inputfile."_supercontig_1_temp \> ".$path_to_tab."big_scaffolds_separated\/".$inputfile."_supercontig_1";
print $commandline;
$status = system($commandline);
$commandline = "rm -f ".$path_to_tab."big_scaffolds_separated\/".$inputfile."_supercontig_1_temp";
print $commandline;
$status = system($commandline);
```
