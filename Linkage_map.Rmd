...
Need to find a cut height and minimum cluster for which at least 48 LGs are created (2n=24 for H. boettgeri see [Mezzasalma et al. 2015](http://www.sciencedirect.com/science/article/pii/S0044523115300036), need to x2 because 1 map per parent). For HetMapps's pipeline documentation: 
